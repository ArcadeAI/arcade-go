...
- <code title="post /v1/admin/secrets/{secret_key}">client.Admin.Secrets.<a href="https://pkg.go.dev/github.com/ArcadeAI/arcade-go#AdminSecretService.New">New</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, secretKey <a href="https://pkg.go.dev/builtin#string">string</a>, body <a href="https://pkg.go.dev/github.com/ArcadeAI/arcade-go">arcadego</a>.<a href="https://pkg.go.dev/github.com/ArcadeAI/arcade-go#AdminSecretNewParams">AdminSecretNewParams</a>) (<a href="https://pkg.go.dev/github.com/ArcadeAI/arcade-go">arcadego</a>.<a href="https://pkg.go.dev/github.com/ArcadeAI/arcade-go#SecretResponse">SecretResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
